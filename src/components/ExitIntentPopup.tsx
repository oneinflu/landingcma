              ...
              <div className="p-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="w-full bg-gradient-to-r from-orange-500 to-red-500 text-white font-bold py-4 px-6 rounded-xl hover:from-orange-600 hover:to-red-500 transition-all flex items-center justify-center gap-2 shadow-lg"
                  >
