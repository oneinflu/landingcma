...
export default function LeadMagnet() {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-gray-900 via-red-900 to-red900 text-white relative overflow-hidden">
      {/* Background Pattern */}
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-12 border border-white/20">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-6">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={() => setShowModal(true)}
                className="bg-gradient-to-r from-red-500 to-red-500 text-white px-8 py-4 rounded-xl font-bold text-lg hover:from-red-600 hover:to-red700 transition-all duration-300 shadow-lg"
              >
          ...
          >
            ...
            >
              ...
              <form className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-red-600 to-red-500 text-white py-3 px-6 rounded-lg font-semibold hover:from-red-700 hover:to-red700 transition-all duration-300"
                >
