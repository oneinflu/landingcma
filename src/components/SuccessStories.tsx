...
const SuccessStories: React.FC = () => {
  ...
  const proofStats: ProofStat[] = [
    ...
    { number: '150', label: 'National & Global Rankers', icon: StarIcon, color: 'text-red-600' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {rankers.map((ranker, index) => (
              ...
              >
                ...
                <div className="p-6 relative">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      <div className="w-10 h-10 bg-gradient-to-r from-red-500 to-red-500 rounded-full flex items-center justify-center shadow-lg group-hover:rotate-12 transition-transform duration-300">
                  ...
                  <div className="mt-4 grid grid-cols-2 gap-3">
                    ...
                    <div className="bg-gradient-to-r from-red-50 to-red50 rounded-xl p-3 border border-red-200/50">
                ...
                <div className="absolute -inset-0.5 rounded-3xl opacity-0 group-hover:opacity-30 transition-opacity duration-300 pointer-events-none bg-gradient-to-r from-yellow-400 via-pink-500 to-red-500 blur-sm"></div>
              </div>
            ))}
          </div>
          ...
          <div className="text-center mt-12">
            <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-red-600 to-red-500 text-white px-8 py-4 rounded-2xl font-bold shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 cursor-pointer">
        ...
        <div ref={statsRef} className="mb-20">
          <div className="bg-gradient-to-r from-slate-900 via-red-900 to-red-900 rounded-2xl p-8 shadow-2xl">
            ...
            <div className="flex animate-scroll space-x-8">
              {[...microStories, ...microStories].map((story, index) => (
                <div key={index} className="flex-shrink-0">
                  <div className="bg-gradient-to-r from-red-100 to-red-100 border border-red-200 rounded-full px-6 py-3">
        ...
        <div className="text-center">
          <button 
            ...
            className="group bg-gradient-to-r from-red-600 to-red-500 hover:from-red-700 hover:to-red-700 text-white font-bold py-4 px-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 mb-4"
          >
          ...
          <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden">
            ...
            <div className="p-6">
              ...
              <div className="flex items-center space-x-4 mb-4">
                ...
                <div className="bg-red-100 px-3 py-1 rounded-full">
                  <span className="text-red-700 font-semibold text-sm">Now at {selectedRanker.currentCompany}</span>
                </div>
              </div>
              <div className="mb-6">
