    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          {/* Header */}
          <div className="bg-gradient-to-r from-red-500 to-red-500 text-white p-6 text-center relative overflow-hidden">
            {/* Animated background */}
            <motion.div
          ...
          <div className="p-6">
            ...
            <div className="mb-6 space-y-3">
              {[
                ...
                { icon: Phone, text: "Free consultation call", color: "text-red-500" }
              ].map((item, index) => (
                <motion.div
                  key={index}
            ...
            <div className="space-y-3">
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="w-full bg-gradient-to-r from-red-500 to-red-500 hover:from-red-600 hover:to-red-700 text-white font-semibold py-4 px-6 rounded-xl transition-all flex items-center justify-center gap-3 shadow-lg"
              >
          ...
          <motion.div
            className="absolute bottom-0 left-0 h-1 bg-gradient-to-r from-red-500 to-red-500"
            initial={{ width: 0 }}
            animate={{ width: "100%" }}
