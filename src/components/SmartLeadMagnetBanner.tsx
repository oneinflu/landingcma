...
export default function SmartLeadMagnetBanner() {
  ...
  return (
    <AnimatePresence>
      ...
      >
        <motion.div
          className="bg-gradient-to-r from-red-600 to-pink-600 text-white rounded-2xl shadow-2xl overflow-hidden relative"
          whileHover={{ scale: 1.02 }}
        >
          {/* Animated background */}
          <motion.div
            className="absolute inset-0 bg-gradient-to-r from-red-500 to-pink-500 opacity-50"
            animate={{
              scale: [1, 1.05, 1],
              rotate: [0, 1, 0]
            }}
              ...
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-3">
                  ...
                  <motion.button
                    ...
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
                    className="w-full bg-white text-red-600 font-bold py-3 px-4 rounded-xl hover:bg-gray-50 transition-colors flex items-center justify-center gap-2"
                  >
